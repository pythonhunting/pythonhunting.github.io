...
gameover_image = pygame.image.load("../images/fly_game_over.png").convert_alpha()
...
while 1:
    ...
    if menu == "game":   
        ...
        if energy >= 0:
            pygame.draw.rect(screen,(200,50,0),(10,110,20,-energy))
            
        if energy <= 0 and not death_time and frog.tongue_dist == 0:
